    ...
    if (form) {
        form.addEventListener('submit', function(event) {
            ...
            if (!dni || dni.length !== 8) {
                ...
                mostrarNotificacion('⚠️ El DNI debe tener 8 dígitos', 'warning');
                document.getElementById('dni').focus();
            ...
            if (!nombres || nombres.trim() === '') {
                event.preventDefault();
                mostrarNotificacion('⚠️ Los nombres son obligatorios', 'warning');
                document.getElementById('dni').focus();
                return false;
            }
            ...
            if (!apellidoPaterno || apellidoPaterno.trim() === '') {
                event.preventDefault();
                mostrarNotificacion('⚠️ El apellido paterno es obligatorio', 'warning');
                document.getElementById('dni').focus();
                return false;
            }
            ...
            if (!apellidoMaterno || apellidoMaterno.trim() === '') {
                event.preventDefault();
                mostrarNotificacion('⚠️ El apellido materno es obligatorio', 'warning');
                document.getElementById('dni').focus();
                return false;
            }
            ...
            if (!especialidad || especialidad === '') {
                event.preventDefault();
                mostrarNotificacion('⚠️ Debe seleccionar una especialidad', 'warning');
            ...
            if (celular && (celular.length !== 9 || !/^\d+$/.test(celular))) {
                event.preventDefault();
                mostrarNotificacion('⚠️ El celular debe tener exactamente 9 dígitos numéricos', 'warning');
